...
export const ActionButtons: FC<ActionButtonsProps> = ({
  ...
  const handleExport = () => {
    ...
    const csvContent = records.map(record => [record.recipient_name, record.certificate_number, record.course_name, record.status, new Date(record.created_at).toLocaleDateString()].join(",")).join("\n");
